...
namespace DayPilot.Web.Mvc.Events.Calendar
{
    public class EventResizeArgs
    {
        ...
        private EventResizeArgs(JsonData parameters, JsonData data)
        {
        ...
        internal static EventResizeArgs FromJson(JsonData parameters, JsonData data)
        {
            return new EventResizeArgs(parameters, data);
        }
