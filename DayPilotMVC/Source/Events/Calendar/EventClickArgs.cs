...
namespace DayPilot.Web.Mvc.Events.Calendar
{
    public class EventClickArgs
    {
        ...
        private EventClickArgs(JsonData parameters, JsonData data)
        {
        ...
        internal static EventClickArgs FromJson(JsonData parameters, JsonData data)
        {
            return new EventClickArgs(parameters, data);
        }
    }
}
