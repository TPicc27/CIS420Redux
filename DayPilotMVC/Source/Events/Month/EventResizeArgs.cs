...
namespace DayPilot.Web.Mvc.Events.Month
{
    ...
    {
        private EventResizeArgs() {}

        private EventResizeArgs(JsonData parameters, string[] fields, JsonData data)
        {
        ...
        internal static EventResizeArgs FromJson(JsonData parameters, string[] fields, JsonData data)
        {
            return new EventResizeArgs(parameters, fields, data);
        }
    }
}
