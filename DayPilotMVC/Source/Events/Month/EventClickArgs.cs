...
namespace DayPilot.Web.Mvc.Events.Month
{
    ...
    {
        private EventClickArgs()
        {
        }

        private EventClickArgs(JsonData parameters, string[] fields, JsonData data)
        {
            Id = (string)parameters["value"];
        ...
        internal static EventClickArgs FromJson(JsonData parameters, string[] p, JsonData data)
        {
            return new EventClickArgs(parameters, p, data);
        }
    }
}
