...
namespace Scheduler.MVC5.Controllers
{
    public class BasicSchedulerController : BaseController
    {
        ...
        public virtual ActionResult Index()
        {
            ...
            var sched = new DHXScheduler(this) {InitialDate = new DateTime(2011, 9, 19)};
        ...
        {
            var sched = new DHXScheduler(this) {InitialDate = new DateTime(2011, 9, 19), Config = {drag_create = false}};
