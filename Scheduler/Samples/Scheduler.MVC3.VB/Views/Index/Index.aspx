   ...
   <ul class="samples_list">
    <li class="category_item"><div><div class="category_icon" style="background-image:url('/Content/Configuration.png')"></div><span>Configuration</span></div>
        <ul>
			...
			<li><div class='sample_link'><%= Html.ActionLink("Drag events between schedulers", "DragBetween", "MultiScheduler", New With {.id = ""}, New With {.target = "_blank"})%></div><div class="sample_description">
