   ...
   <ul class="samples_list">
    <li class="category_item"><div><div class="category_icon" style="background-image:url('/Content/Configuration.png')"></div><span>Configuration</span></div>
        <ul>
			...
			<li><div class='sample_link'><%= Html.ActionLink("Multisection events", "Index", "Multisection", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Event can be assigned to several sections of Timeline or Units at the same time.</div>
            </li>
			...
			<li><div class='sample_link'><%= Html.ActionLink("Drag events between schedulers", "DragBetween", "MultiScheduler", new { id = "" }, new { target = "_blank" })%></div><div class="sample_description">
            Events can be dragged from one calendar to another.</div>
            </li>
        </ul>
    </li>
